...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Halls system - Print Payment</title>
                            ...
                            <!-- Invoice Company Details starts -->
                                <div id="invoice-company-details" class="row">
                                    ...
                                    <div class="col-md-6 col-12 text-right">
                                        <h2 class="primary text-uppercase">Reservation Payment Receipt</h2>
                                        <p class="pb-3"># Reservation ID: {{$payment->reservation->id}}</p>
                                        <ul class="px-0 list-unstyled">
                                            <li>Total Balance Due</li>
                                            <li class="font-medium-2 text-bold-700">{{$payment->reservation->total}} SDG</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div id="invoice-customer-details" class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <ul class="m-0 list-unstyled">
                                            <li class="text-bold-800">Mr. {{$payment->reservation->customer->name}}</li>
                                            <li>{{$payment->reservation->customer->email}}</li>
                                            <li>{{$payment->reservation->customer->phone}}</li>
                                            <li>Khartoum - Sudan</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6 col-12 text-right">
                                        <p><span class="text-muted">Reservation Date :</span> {{date('d/m/Y', strtotime($payment->reservation->date))}}</p>
                                        <p><span class="text-muted">Terms :</span> Due on Receipt</p>
                                        <p><span class="text-muted">Payment Date :</span> {{date('d/m/Y', strtotime($payment->created_at))}}</p>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            <tbody>
                                                                <tr>
                                                                    <td>Amount</td>
                                                                    <td class="text-right">{{$payment->value}} SDG</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Payment Method</td>
                                                                    <td class="text-right">{{$payment->payment_method}} SDG</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                            ...
                                            <div class="row mt-2 mt-sm-0">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="signature text-center">
                                                        ...
                                                        <h6 class="mt-4">{{$payment->user->name}}</h6>
                                                        <p class="text-muted">Reciever</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
